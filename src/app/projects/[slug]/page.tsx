...
export default function ProjectDetailPage({ params }: { params: { slug: string } }) {
  ...
  return (
    <Container className="py-20">
      ...
      <h1 className="mt-2 text-4xl font-semibold tracking-tight text-slate-900 sm:text-5xl dark:text-white">{p.name}</h1>
      <p className="mt-3 text-lg text-slate-600 dark:text-slate-300">{p.oneLiner}</p>
